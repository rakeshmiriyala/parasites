    ...
    <div className="relative bg-white text-gray-800 px-6 py-16 lg:px-24 overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-gray-100 rounded-xl p-6 shadow hover:shadow-lg transition">
              <h4 className="text-lg font-bold mb-2 text-blue-700">✔ Leading Expertise</h4>
            ...
            <div className="bg-gray-100 rounded-xl p-6 shadow hover:shadow-lg transition">
              <h4 className="text-lg font-bold mb-2 text-blue-700">✔ Tailored Solutions</h4>
              <p className="text-black">
            ...
            <div className="bg-gray-100 rounded-xl p-6 shadow hover:shadow-lg transition">
              <h4 className="text-lg font-bold mb-2 text-blue-700">✔ Global Delivery</h4>
              <p className="text-black">
        ...
        <div className="bg-blue-50 rounded-xl p-6 shadow-md">
          ...
          <p className="mt-4 text-xl font-bold text-blue-700">Exelus Labs — Quality Leads.</p>
        </div>
      </div>
    </div>
  );
