...
const Navbar = () => {
  ...
  const menuLinks = {
    Home: [
      { name: "Introduction", path: `/home/introduction` },
      { name: "Features", path: `/home/features/${id || 1}` },
      { name: "Testimonials", path: `/home/testimonials/${id || 1}` },
      { name: "Pricing", path: `/home/pricing/${id || 1}` },
      { name: "FAQ", path: `/home/faq/${id || 1}` },
      { name: "Blog", path: `/home/blog/${id || 1}` },
    ],
    About: [
          ...
          {Object.keys(menuLinks).map((menu, index) => (
            ...
            >
              ...
              <AnimatePresence>
                {activeDropdown === menu && (
                  <motion.ul
                    className="absolute left-0 mt-2 w-56 bg-gray-800 text-white rounded shadow-lg"
                    onMouseEnter={() => handleMouseEnter(menu)}
                    onMouseLeave={handleMouseLeave}
