...
const AboutUs = () => {
  return (
    <div className="relative bg-white text-gray-800 xs:px-10 sm:px-12 lg:px-24 py-12 sm:py-16 overflow-hidden">
      {/* Background Image */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <p className="text-base sm:text-lg text-start text-black mb-10 sm:mb-12 leading-relaxed">
        ...
        <div className="mb-10 sm:mb-12">
          <h2 className="text-xl sm:text-2xl font-semibold text-black mb-4">What We Do</h2>
        ...
        <div className="mb-10 sm:mb-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            <div className="bg-gray-100 rounded-xl p-4 sm:p-6 shadow transition">
              <h4 className="text-base sm:text-lg font-bold mb-2 text-blue-600">
                ✔ Leading Expertise
              </h4>
        ...
        <div className="bg-gray-100 rounded-xl p-4 sm:p-6 shadow">
          ...
          <p className="mt-4 text-lg sm:text-xl font-bold text-blue-600">
            Exelus Labs — Quality Leads.
          </p>
        </div>
      </div>
    </div>
